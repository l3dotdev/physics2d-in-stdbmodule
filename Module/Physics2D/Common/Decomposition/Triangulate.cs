...
public static class Triangulate
{
    ...
    /// </param>
    public static List<Vertices> ConvexPartition(Vertices vertices, TriangulationAlgorithm algorithm, bool discardAndFixInvalid = true, double tolerance = 0.001, bool skipSanityChecks = false)
    {
        if (vertices.Count <= 3)
            return [vertices];
