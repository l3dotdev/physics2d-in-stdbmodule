...
using StdbModule.Physics2D.Common.Decomposition.Seidel;
...
internal static class SeidelDecomposer
{
    ...
    public static List<Vertices> ConvexPartition(Vertices vertices, double sheer = 0.001)
    {
    ...
    public static List<Vertices> ConvexPartitionTrapezoid(Vertices vertices, double sheer = 0.001)
    {
        List<Point> compatList = new List<Point>(vertices.Count);
