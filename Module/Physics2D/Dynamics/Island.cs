...
public class Island
{
    ...
    public void Reset(int bodyCapacity, int contactCapacity, int jointCapacity, ContactManager contactManager)
    {
        ...
        if (_contacts == null || _contacts.Length < contactCapacity)
        {
            ...
            newContactBufferCapacity = newContactBufferCapacity + (newContactBufferCapacity * 2 >> 4); // grow by x1.125
    ...
    internal void Solve(ref TimeStep step, ref Vector2 gravity)
    {
        ...
        for (int i = 0; i < BodyCount; ++i)
        {
            ...
            if (b.BodyType == BodyType.Dynamic)
            {
                ...
                // Taylor expansion:
                // v2 = (1.0 - c * dt) * v1
                v *= MathUtils.Clamp(1.0 - h * b.LinearDamping, 0.0, 1.0);
                w *= MathUtils.Clamp(1.0 - h * b.AngularDamping, 0.0, 1.0);
            }
        ...
        for (int i = 0; i < BodyCount; ++i)
        {
            ...
            {
                double ratio = Settings.MaxTranslation / translation.Length;
                v *= ratio;
            }
        ...
        {
            double minSleepTime = MathUtils.MaxDouble;
