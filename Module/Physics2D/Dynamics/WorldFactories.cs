...
{
    public virtual Body CreateBody(Vector2 position = new Vector2(), double rotation = 0, BodyType bodyType = BodyType.Static)
    {
        Body body = new()
        {
            Position = position,
    ...
    public Body CreateRectangle(double width, double height, double density, Vector2 position = new Vector2(), double rotation = 0, BodyType bodyType = BodyType.Static)
    {
        if (width <= 0)
    ...
    public Body CreateCircle(double radius, double density, Vector2 position = new Vector2(), BodyType bodyType = BodyType.Static)
    {
    ...
    public Body CreateEllipse(double xRadius, double yRadius, int edges, double density, Vector2 position = new Vector2(), double rotation = 0, BodyType bodyType = BodyType.Static)
    {
        Body body = CreateBody(position, rotation, bodyType);
    ...
    public Body CreatePolygon(Vertices vertices, double density, Vector2 position = new Vector2(), double rotation = 0, BodyType bodyType = BodyType.Static)
    {
        Body body = CreateBody(position, rotation, bodyType);
    ...
    public Body CreateCompoundPolygon(List<Vertices> list, double density, Vector2 position = new Vector2(), double rotation = 0, BodyType bodyType = BodyType.Static)
    {
    ...
    public Body CreateGear(double radius, int numberOfTeeth, double tipPercentage, double toothHeight, double density, Vector2 position = new Vector2(), double rotation = 0, BodyType bodyType = BodyType.Static)
    {
    ...
    public Body CreateCapsule(double height, double topRadius, int topEdges, double bottomRadius, int bottomEdges, double density, Vector2 position = new Vector2(), double rotation = 0, BodyType bodyType = BodyType.Static)
    {
    ...
    public Body CreateCapsule(double height, double endRadius, double density, Vector2 position = new Vector2(), double rotation = 0, BodyType bodyType = BodyType.Static)
    {
        //Create the middle rectangle
        Vertices rectangle = PolygonTools.CreateRectangle(endRadius, height / 2);

        List<Vertices> list = [rectangle];
    ...
    public Body CreateRoundedRectangle(double width, double height, double xRadius, double yRadius, int segments, double density, Vector2 position = new Vector2(), double rotation = 0, BodyType bodyType = BodyType.Static)
    {
    ...
    public Body CreateLineArc(double radians, int sides, double radius, bool closed = false, Vector2 position = new Vector2(), double rotation = 0, BodyType bodyType = BodyType.Static)
    {
        Body body = CreateBody(position, rotation, bodyType);
    ...
    public Body CreateSolidArc(double density, double radians, int sides, double radius, Vector2 position = new Vector2(), double rotation = 0, BodyType bodyType = BodyType.Static)
    {
        Body body = CreateBody(position, rotation, bodyType);
    ...
    /// <returns></returns>
    public Common.Path CreateChain(Vector2 start, Vector2 end, double linkWidth, double linkHeight, int numberOfLinks, double linkDensity, bool attachRopeJoint)
    {
        System.Diagnostics.Debug.Assert(numberOfLinks >= 2);

        //Chain start / end
        Common.Path path = new();
        path.Add(start);
        path.Add(end);
